...
[new] 2026-04-29 | tools/equity_impact.sh + tools/lib/equity_impact.py + tools/prompts/equity_impact.md + .claude/skills/equity-impact/SKILL.md + briefings/ | impact briefing diario que cruza morning-briefing emails ($TEMP/briefing/) + relatorio CVM diario (\10.10.10.2\Dados\...\CVM-API\relatorio_<date>.html) com a cobertura (calendario_resultados.md + manifests). LLM-only matching: Python apenas empacota inputs (~37 empresas + 230 emails + CVM text + calendar today em ~150K chars), Sonnet faz match+filtragem+sintese em uma passada. Output read-only em briefings/<YYYY-MM-DD>-impact.md. Sem auto-fetch/ingest. Sample manual gerado para 2026-04-28 valida formato. Auth issue: claude --print retorna 401 em sessao longa nesta sessao (OAuth token expirou); scheduled task vai usar sessao nova, sem problema.
2026-04-29 — ingest itr 1T26: sources/full/weg/1T26/itr.md, sources/structured/weg/1T26/itr.json, sources/digested/weg_itr_1T26_summary.md
2026-04-29 — ingest release 1T26: sources/full/weg/1T26/release.md, sources/structured/weg/1T26/release.json, sources/digested/weg_release_1T26_summary.md
2026-04-29 — ingest fato_relevante 2T26: sources/full/weg/2T26/fato_relevante_WEGE3_2T26_previa_operacional_1028875_extracted.md.md, sources/digested/weg_fatos_relevantes_batch_summary.md
...
[edit] 2026-04-29 | weg.md | update: add 1T26 ITR+release (ROL 9.468mm, margem EBITDA 22,2%, ROIC 33,1%, caixa liq 3.322mm); extend quarterly/segmentos tables; add 1T26 results section
[edit] 2026-04-29 | banco_do_brasil.md | add BB Day 2026 content: desempenho 2025, conglomerado market shares, provisao agro magnitude, novo framework garantias, consignado privado atualizado, tecnologia/digital, sustentabilidade, risco insumos safra 26-27
[edit] 2026-04-29 | santander.md | update: integrated notion_santander_santander_call_4t25_35100ca3 (call 4T25 CEO Mário despedida) — adicionadas seções transição liderança (Gilson CEO / Carlos Muniz CFO), base de clientes (75mm), Desenrola 2.0, Cartões/Financeira metrics, funding PF/PJ 51/49, Gravity savings R$400mm, IA targets, DTA absorption timeline 2027-2028, updated capital CET1 11,2[edit] 2026-04-29 | santander.md | update: integrated notion_santander_santander_call_4t25_35100ca3 (call 4T25 farewell Mário Leão) — new sections: transição liderança (Gilson CEO / Carlos Muniz CFO), base de clientes (75mm), Desenrola 2.0; expanded: cartoes/financeira, funding PF/PJ 51/49, Gravity savings R$400mm, IA targets, DTA absorption 2027-2028, capital CET1 11.2%/Basileia 15.2%, guidance 2026
[edit] 2026-04-29 | wellhub.md | update | added digest notion_wellhub_renato_vp_pme_global_wellhub_34f00ca3_summary: PME segment, breakage mechanics, TotalPass B2C launch fev/2026, price differential 3x, product convergence, Germany acquisition, Food Voucher clarification
[update] 2026-04-29 | totalpass.md | add: TotalPass B2C via Ticket/Alelo (fev/2026), PME 100-vidas gratis, competitive pricing gap 3x vs Wellhub, Germany reference | fonte: notion_wellhub_renato_vp_pme_global_wellhub_34f00ca3_summary
[edit] 2026-04-29 | caixa.md | added FGTS section (saque-aniversário, orçamento 2026, subsídios, Fundo Social, sustentabilidade) from notion_call_fgts_34b00ca3
[edit] 2026-04-29 | bb_seguridade.md | update: added BB Day 2026 data — market shares (62% seguros rurais, 12% vida/morte mista), agro crisis context e recovery, consignado privado base (R$ 17.2bi), geopolitical input cost risk safra 26-27
[edit] 2026-04-29 | banco_votorantim.md | add BB Day 2026 source: BV maior financiador de veículos do país
[edit] 2026-04-29 | mcmv.md | add notion_call_fgts_34b00ca3: FGTS orçamento 2026 breakdown, saque-aniversário R$211bi drain + restrict, subsídio origin 100% FGTS, Fundo Social blend 50/50, sustainability risks, remuneração FGTS
