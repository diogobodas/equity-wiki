...
**Leitura cross-company:** a Cyrela é a maior incorporadora por receita (R$ 9,4 bi, ~2x os pares MCMV), mas opera com ROE e margens bruta menores — reflexo do segmento alta renda (ciclo longo, capital intensivo) e da presença de minoritários relevantes (R$ 389 mm em 2025) e equivalência patrimonial (R$ 548 mm) via SPEs e coligadas (Cury, Plano&Plano). Entre os players MCMV, a Cury opera em um nível à parte — **ROE 78,8%** é sem precedente para uma incorporadora listada brasileira ou global. A combinação de receita líder entre MCMV (R$ 5,4 bi), margem bruta forte (39,8% — intermediária entre Tenda 30,1% e Direcional 42,1%) e **base de PL deliberadamente baixa** (payout ~138% em 2025, via follow-on + dividendos extraordinários) é o que produz o ROE excepcional (fonte: digested/cury_dfp_2025_summary.md). A Direcional lidera em margem bruta ajustada (42,1%, recorde histórico), enquanto a Tenda lidera em velocidade de turnaround — ROE de 47,1% partindo de prejuízo em 2022 (fonte: digested/direcional_release_4T25_summary.md, digested/tenda_release_4T25_summary.md).
...
3. **Bancos de terrenos recordes.** Dados mais recentes (1T26 para quem divulgou prévia, 4T25 para Cyrela): Direcional R$ 60,0 bi (87% permuta, 246 mil unidades), Tenda R$ 29,7 bi (71,2% permuta, 139 mil unidades), Cury R$ 24,9 bi (SP+RJ, 82 mil unidades), Cyrela R$ 19,8 bi (94% CBR). Setor acumulando 3–9 anos de lançamentos no ritmo atual — bem posicionado para ciclo de crescimento 2026–2028, mas intensivo em capital de giro (fonte: digested/direcional_previa_operacional_1T26_summary.md, digested/tenda_previa_operacional_1T26_summary.md, digested/cury_previa_operacional_1T26_summary.md, digested/cyrela_release_4T25_summary.md).

4. **[[debentures|Debêntures]] e CRI como captação padrão.** Todas as empresas recorreram a emissões de debêntures e cessões pro-soluto de recebíveis (CRIs) como funding primário em 2025. Tenda: 13ª emissão de R$ 300 mm, custo médio 13,67% a.a., duration 24,2 meses. Direcional: CRI de R$ 438 mm em jan/2026, prazo médio 64–68 meses. Cyrela: dívida corporativa total R$ 5,4 bi (Cyrela R$ 2,6 bi + CashMe R$ 2,8 bi), custo 97,9% CDI, prazo 4,5 anos. Cury: dívida bruta R$ 1,47 bi, 79,7% LP, vencimentos até 2035 (fonte: digested/tenda_dfp_2025_summary.md, digested/direcional_release_4T25_summary.md, digested/cyrela_release_4T25_summary.md, digested/cury_release_4T25_summary.md).

5. **Dividendos extraordinários por reforma tributária.** Direcional antecipou R$ 804 mm em dez/2025 por mudança na Lei 15.270/2025. Cury distribuiu R$ 1,35 bi no ano (payout ~138%), financiado em parte por follow-on primário de R$ 574 mm — arranjo atípico de reciclagem de equity que permitiu entrada no Ibovespa + ampliação de free float. Cyrela pagou R$ 1,4 bi em dividendos (recorde histórico). Tenda distribuiu R$ 150 mm (29,7% payout) — retorno ao dividendo após anos de prejuízo (fonte: digested/direcional_release_4T25_summary.md, digested/cury_dfp_2025_summary.md, digested/cyrela_release_4T25_summary.md, digested/tenda_dfp_2025_summary.md).
...
A Cyrela tem o maior backlog absoluto (R$ 11,2 bi), refletindo seu porte e ciclo mais longo de alta renda. Direcional e Cury lideram em margem REF (44,6% e 43,3%), sinalizando margens brutas crescentes nos próximos trimestres.
...
Relacionado: [[vgv]], [[vso]], [[distrato]], [[repasses]], [[banco_de_terrenos]], [[mcmv]], [[resultado_a_apropriar]], [[debentures]], [[reforma_tributaria]]
