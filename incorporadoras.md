...
- **Média renda (MCMV Faixa 3/4 + [[sbpe|SBPE]])** — ticket intermediário, funding misto, sensibilidade maior a juros. Players: [[riva|Riva]] (subsidiária Direcional), Plano&Plano, Cury, MRV, [[alea|Alea]] (subsidiária Tenda — em reestruturação).
...
Fontes: (fonte: structured/tenda/2025/dfp.json :: canonical.dre), (fonte: structured/direcional/2025/release.json :: canonical.dre).

As duas empresas têm receita e ROE comparáveis, mas a **estrutura de margem e custo de capital é muito diferente**. Ver [[tenda_vs_direcional]] para análise detalhada.

## Tendências visíveis nos dados 2025

1. **Turnaround consolidado pós-crise 2021-2023.** Tenda retornou ao lucro (R$ 506 mm vs prejuízo R$ 547 mm em 2022) e Direcional entregou recordes consecutivos. O ciclo de quase-quebra do setor MCMV Faixa 1 está oficialmente fechado nos nomes líderes (fonte: full/tenda/data_pack_1T26.md, full/direcional/4T25/release.md).

2. **Distratos em alta.** Ambas as empresas reportaram aumento de distratos em 2025. Direcional saltou de 8,3% em 2024 para 12,8% em 2025 (14,8% no 4T25). Ponto de atenção setorial — reflete base maior de vendas, mas tendência merece monitoramento (fonte: full/direcional/4T25/release.md §distratos).

3. **Bancos de terrenos recordes.** Direcional com R$ 58,5 bi (87% permuta) e Tenda com R$ 28,6 bi (73,9% permuta) em 4T25, cobrindo 4-9 anos de lançamentos no ritmo atual. Setor bem posicionado para ciclo de crescimento 2026-2028.
...
5. **Dividendos extraordinários por reforma tributária.** Direcional antecipou R$ 804 mm em dez/2025 por mudança na Lei 15.270/2025. Movimento setorial esperado (fonte: full/direcional/4T25/fato_relevante_1.md).
