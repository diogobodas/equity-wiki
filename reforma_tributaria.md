...
sources:
  ...
  - sources/digested/direcional_fatos_relevantes_batch_summary.md
...
A reforma tributária sobre consumo, instituída pela **Emenda Constitucional nº 132/2023** e regulamentada pela **Lei Complementar nº 214/2025** (com alterações da LC 227/2026), substitui gradualmente PIS, COFINS, ICMS, ISS e IPI por três novos tributos: a **Contribuição sobre Bens e Serviços (CBS)**, de competência federal, o **Imposto sobre Bens e Serviços (IBS)**, de competência estadual e municipal, e o **Imposto Seletivo (IS)**, sobre bens prejudiciais à saúde e ao meio ambiente (fonte: digested/Texto Reforma tributaria jan-2025_summary.md).

Princípios-chave do novo sistema: **neutralidade** (não distorcer decisões de consumo ou organização econômica), **não cumulatividade plena** (crédito amplo sobre todas as aquisições, incluindo ativo imobilizado), tributação no **destino** (tributo devido no local de consumo), **split payment** (recolhimento automático na liquidação financeira da transação) e **cashback** (devolução personalizada para famílias de baixa renda como mecanismo de progressividade) (fonte: digested/Texto Reforma tributaria jan-2025_summary.md).

## Cronograma de transição

| Ano | Evento |
|---|---|
| 2023 | EC nº 132/2023 promulgada (20/dez) |
| 2025 | LC 214/2025 regulamenta CBS/IBS/IS; Lei 15.270/2025 — possibilidade de tributação de dividendos a partir de 2026 |
| 2027 | Início da CBS (alíquota-teste); PIS/Cofins coexistem (fonte: digested/Texto Reforma tributaria jan-2025_summary.md) |
| 2029 | Início do IBS (alíquota-teste); ICMS/ISS coexistem. Último exercício para optar pelo RET em novos empreendimentos (fonte: digested/notas_mattos_filho_reforma_incorporadoras_summary.md) |
| 2027–2033 | Período de calibração — alíquotas ajustadas anualmente para manter carga tributária neutra (fonte: digested/Texto Reforma tributaria jan-2025_summary.md) |
| 2032 | Sistema integralmente migrado — fim do ICMS, PIS-COFINS e RET (fonte: digested/notas_mattos_filho_reforma_incorporadoras_summary.md) |
| 2033 | Fixação definitiva das alíquotas do regime financeiro (fonte: digested/Texto Reforma tributaria jan-2025_summary.md) |
| 2035 | Extinção completa de PIS/Cofins/IPI/ICMS/ISS (fonte: digested/Texto Reforma tributaria jan-2025_summary.md) |

## Impactos para incorporadoras

A LC 214/2025 dedica um capítulo específico a bens imóveis (Cap. V, arts. 251–270) com regime diferenciado para operações imobiliárias (fonte: digested/Texto Reforma tributaria jan-2025_summary.md).

### Regime específico para imóveis

- **Alíquota reduzida em 50%** da alíquota-padrão para alienação, construção civil e intermediação imobiliária (fonte: digested/Texto Reforma tributaria jan-2025_summary.md).
...
A alíquota efetiva de IR das incorporadoras no RET é estruturalmente baixa. A [[tenda|Tenda]], por exemplo, registrou alíquota efetiva de apenas 1,23% em 2025, dado que o RET domina e não há perspectiva de Lucro Real — mesmo acumulando R$ 2,67 bi em prejuízo fiscal não reconhecido (crédito fiscal de R$ 906,7 mm) (fonte: digested/tenda_dfp_2025_summary.md).

### Impacto de caixa

No modelo atual, tributos são recolhidos conforme a evolução física da obra. Com a reforma, haverá **desembolso tributário concentrado no início** (alíquota estimada em ~14% em 2033 sobre todo fornecimento), gerando créditos que só serão utilizados ao longo da execução (fonte: digested/notas_mattos_filho_reforma_incorporadoras_summary.md).
...
A não cumulatividade plena prevista no IVA dual — crédito amplo sobre todas as aquisições de bens e serviços, incluindo ativo imobilizado (fonte: digested/Texto Reforma tributaria jan-2025_summary.md) — poderá gerar recuperação de tributos sobre materiais, serviços e subempreitadas, reduzindo o custo de produção. Empresas com alto grau de industrialização e menor componente de mão de obra — como a Tenda com seu modelo de fôrmas de alumínio — tendem a se beneficiar mais, por terem maior proporção de insumos tributáveis e creditáveis (fonte: full/tenda/4T25/release.md §mensagem_administração).

O crédito passa a ser **elemento central** da gestão tributária do setor — um setor que nunca gerou crédito precisará de mudança cultural profunda em sistemas de gestão, contabilidade e controle gerencial para diferenciar custo efetivo de tributo recuperável (fonte: digested/notas_mattos_filho_reforma_incorporadoras_summary.md).

### Mudanças estruturais na cadeia produtiva

A reforma introduz incentivos que podem alterar a estrutura operacional das [[incorporadoras]] (fonte: digested/notas_mattos_filho_reforma_incorporadoras_summary.md):
...
A substituição tributária nos shoppings gera debate sobre repasse de tributos: operadores defendem repassar apenas o valor líquido (após créditos), mas isso exigiria abertura completa de custos do shopping, algo inviável no mercado privado. Solução mais adequada: **cláusula de preço líquido** nos contratos (retira tributo atual, substitui pelo futuro, mantendo neutralidade econômica) (fonte: digested/notas_mattos_filho_reforma_incorporadoras_summary.md).

Na venda de ativos (shopping centers), além de ganho de capital e ITBI, passa-se a conviver com IBS e CBS — fator adicional na precificação (fonte: digested/notas_mattos_filho_reforma_incorporadoras_summary.md).

## Impactos para bancos e instituições financeiras

A LC 214/2025 prevê regime específico para serviços financeiros (Cap. II, arts. 181–233) (fonte: digested/Texto Reforma tributaria jan-2025_summary.md):

- **Base de cálculo** = receitas das operações financeiras, com deduções próprias (provisões, perdas com crédito, etc.).
- **Alíquotas próprias** (art. 189), nacionalmente uniformes, calibradas de 2027 a 2033 e fixadas a partir de 2034.
- Créditos de IBS/CBS na aquisição de serviços financeiros **restritos** a informações prestadas pelos fornecedores ao Comitê Gestor.
- Serviços bancários remunerados por **tarifas** (abertura de conta, saque, transferência) seguem o regime geral, não o específico.
- Abrange: operações de crédito, câmbio, títulos e valores mobiliários, securitização, leasing, seguros, previdência privada, arranjos de pagamento, ativos virtuais.

## Lei 15.270/2025 — tributação de dividendos

Além da reforma sobre consumo, a **Lei nº 15.270/2025** trouxe a possibilidade de taxação de dividendos distribuídos a partir de 2026, mesmo que provenientes de reservas de lucro previamente constituídas. Essa mudança provocou uma antecipação massiva de distribuições no final de 2025:

| Empresa | Dividendos 2025 | Antecipação dez/2025 | Observação |
|---|---:|---:|---|
| [[direcional\|Direcional]] | R$ 1,45 bi | R$ 804 mm | DL/PL subiu para 23,0% pela antecipação (fonte: digested/direcional_release_4T25_summary.md) |
| [[cury\|Cury]] | R$ 1,35 bi | — | Payout 138% do lucro; usou reservas acumuladas (fonte: digested/cury_dfp_2025_summary.md) |
