...
| Tenda-2025-12-31-wPTjC7R6.pdf | file / dfp | tenda | 2025 | full/tenda/2025/dfp.md · structured/tenda/2025/dfp.json · digested/tenda_dfp_2025_summary.md | — | **DFP 2025 auditada** (79p). Primeira fonte auditada da Tenda. Destravou DFC completa, notas explicativas 1–25 e segmentação contábil on-site/off-site. Supersedes data_pack 2025 para DRE/BP/DFC/notas (cross-check ±0). Original apagado. |
| Tenda-2024-12-31-B9PKrChn.pdf | file / dfp | tenda | 2024 | full/tenda/2024/dfp.md · structured/tenda/2024/dfp.json · digested/tenda_dfp_2024_summary.md | — | **DFP 2024 auditada** (68p). Captura o ano da virada (LL +106,4 mm vs prej -95,8 em 2023, DLcorp/PL -10,3%). SWAP TEND3 ainda passivo (-18,6 mm) — virada para receita só em 2025. RET 1 (0,47%) primeira aparição. Supersedes data_pack 2024 para DRE/BP/DFC/notas. Original apagado. |
| SUSEP Exporta (1).xls (export sistema Estatísticas) | generic / análise setorial | — | 201001–202602 (194 obs) | full/generic/susep_sinistralidade_auto_analise_2010_2026.md | oficial | Mercado agregado auto (ramos 0520, 0523, 0524, 0525, 0526, 0531, 0542, 0544, 0553). Análise de sazonalidade de sinistralidade + teste calendário (dias úteis, Carnaval). Concept pages `sinistralidade_auto.md` e `premio_retido_vs_ganho.md` derivam. Scripts em `analises/sinistralidade_auto/` (fora do repo). |
